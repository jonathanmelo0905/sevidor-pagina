            ...
            if (seleccion === 1) {
                try {
                    yield mailer_1.transporter.sendMail({
                        from: '"Información Proyectos Hábitat Constructores" <jonathanmelo0905@gmail.com>',
                        to: correo,
                        subject: "Información Apartamentos Nissi Condominio Campestre, Villeta",
                        text: "Hello world?",
                        html: `
                ...
                try {
                    yield mailer_1.transporter.sendMail({
                        from: '"Información Proyectos Hábitat Constructores" <jonathanmelo0905@gmail.com>',
                        to: correo,
                        subject: "Información Montes del Retiro Payandé",
                        text: "Hello world?",
                        html: `
                ...
                try {
                    yield mailer_1.transporter.sendMail({
                        from: '"Información Proyectos Hábitat Constructores" <jonathanmelo0905@gmail.com>',
                        to: correo,
                        subject: "Información Casa 7- Nissi Condominio Campestre, Villeta",
                        text: "Hello world?",
                        html: `
                    <div class="correo" style="display: grid; grid-template-columns: 100%; padding: 10px 0; text-align: justify;font-size: small;">
                    <p>${genero} <b>${nombre},</b></p>
